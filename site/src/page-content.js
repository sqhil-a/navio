...
export const pageContent = {
  "/": {
    ...
    <section class="section section-dark"><div class="container feature-panel"><div><p class="eyebrow">Navio Journal</p><h2>Research for clearer futures.</h2><p>Coming soon, the Navio Journal will connect student-led research with the questions young people have about education, careers, technology, and what comes next.</p><a class="button button-primary" href="https://journal.naviopathways.com/">Explore Navio Journal <span aria-hidden="true">→</span></a></div></div></section>
    <section class="section"><div class="container trust-panel"><div><p class="eyebrow">Built for youth. Supported by community.</p><h2>Clear about where we are today.</h2><p>Navio Pathways is an Ontario incorporated not-for-profit. We publish opportunities only when the details are confirmed, and we do not claim impact numbers that have not been verified.</p></div><dl class="trust-facts"><div><dt>Organization</dt><dd>Ontario not-for-profit, Corporation Number 1001662092</dd></div><div><dt>Focus</dt><dd>Youth career and community development</dd></div><div><dt>Current status</dt><dd>Programs and partnerships in development</dd></div></dl></div></section>
  ...
  "/get-involved/": {
    ...
    <section class="section" id="executive-team"><div class="container narrow feature-panel"><div><p class="eyebrow">Executive team</p><h2>Help shape Navio Pathways.</h2><p>We are looking for thoughtful people who can take ownership, communicate reliably, and help build programs, partnerships, operations, or outreach.</p><p>See the application and executive position information in one place.</p><a class="button button-primary" href="/links/">Apply to the executive team</a></div></div></section>
