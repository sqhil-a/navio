...
export const pageContent = {
  "/": {
    ...
    <section class="section section-dark"><div class="container feature-panel"><div><p class="eyebrow">Navio Journal</p><h2>Research for clearer futures.</h2><p>The Navio Journal connects youth-focused research and practical guidance with questions about education, careers, technology, and what comes next.</p><a class="button button-primary" href="https://journal.naviopathways.com/">Explore Navio Journal <span aria-hidden="true">→</span></a></div></div></section>
    <section class="section"><div class="container trust-panel"><div><p class="eyebrow">Built for youth. Supported by community.</p><h2>An Ontario incorporated not-for-profit.</h2><p>Navio Pathways supports youth career exploration, leadership development, volunteering, and informed decision-making. Our public information identifies the organization clearly and avoids unsupported impact, partnership, or outcome claims.</p></div><dl class="trust-facts"><div><dt>Legal name</dt><dd>Navio Pathways</dd></div><div><dt>Corporation number</dt><dd>1001662092</dd></div><div><dt>Registered address</dt><dd>3140 Polo Place, Mississauga, Ontario</dd></div></dl></div></section>
  ...
  "/about/": {
    ...
    <section class="section section-tint"><div class="container narrow"><p class="eyebrow">Leadership</p><h2><a class="title-link" href="https://sqhil-a.github.io/portfolio/" target="_blank" rel="noopener noreferrer">Sahil Ambegaonkar</a></h2><p>Sahil is the Founder and President of Navio Pathways. He created the organization after seeing how often students are expected to make major career decisions without enough context, structure, or encouragement.</p><p>Additional executive and board biographies will be published only after roles, names, and consent are confirmed.</p><a class="text-link" href="/get-involved/#executive-team">Contact Navio about involvement <span aria-hidden="true">→</span></a></div></section>
  ...
  "/get-involved/": {
    ...
    noindex: false,
    html: `${internalHero("Get involved", "Help build practical opportunities for young people.", "Choose the role that fits your experience and availability. Navio publishes only confirmed ways to contribute and uses direct organization contact for inquiries.")}
    <section class="section" id="executive-team"><div class="container narrow feature-panel"><div><p class="eyebrow">Organization involvement</p><h2>Help shape Navio Pathways.</h2><p>People interested in supporting Navio Pathways can contact the organization directly about operations, outreach, resource development, community relationships, or youth-focused work.</p><p>Describe your experience, availability, and the kind of contribution you would like to discuss.</p><a class="button button-primary" href="mailto:${email}?subject=Navio%20Pathways%20involvement">Contact the organization</a></div></div></section>
  ...
  "/privacy/": {
    ...
    <section class="section"><div class="container narrow policy-copy"><h2>Information you choose to send</h2><p>This website does not contain inquiry forms or collect application data. If you email us or use an official social profile, the relevant service processes the information you choose to provide.</p><h2>Analytics</h2><p>Analytics is disabled unless a valid measurement ID is configured after privacy review. We do not intentionally send message content to analytics services.</p><h2>Youth privacy</h2><p>Do not send unnecessary sensitive information about a young person. Program-specific consent, retention, access, and safeguarding procedures must be confirmed before collecting participant information.</p><h2>Contact</h2><p>Questions can be sent to <a href="mailto:${email}">${email}</a>.</p></div></section>`,
  },
  ...
  "/links/": {
    ...
    description: "Open the official Navio Pathways website, contact email, and social links.",
    noindex: true,
    html: `<section><h1>Navio Pathways links</h1><p>Connect with Navio Pathways through the official website, organization email, and social profiles.</p></section>`,
  },

  "/journal/": {
    path: "/journal/",
    title: "Navio Journal | Navio Pathways",
    description: "Continue to Navio Journal for practical career exploration articles for students, families, and educators.",
    noindex: true,
    html: `<section><h1>Navio Journal</h1><p>Continue to the official Navio Pathways journal.</p></section>`,
  },
