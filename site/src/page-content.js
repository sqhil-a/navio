...
export const pageContent = {
  ...
  "/get-involved/": {
    ...
    noindex: false,
    html: `${breadcrumb("Get involved")}${internalHero("Get involved", "Help build practical opportunities for young people.", "Choose the role that fits your experience and availability. We will always be clear about what is active and what is still being developed.")}
  ...
  "/contact/": {
    ...
    noindex: false,
    html: `${breadcrumb("Contact")}${internalHero("Contact", "Talk directly with our team.", "Use email for detailed questions or Instagram for updates and quick contact.")}
    <section class="section"><div class="container contact-grid simple-contact"><a class="contact-card" href="mailto:${email}"><span aria-hidden="true">@</span><div><p class="eyebrow">Email</p><h2>${email}</h2><p>Best for opportunities, volunteering, schools, partnerships, and detailed questions.</p></div></a><a class="contact-card" href="${instagram}" target="_blank" rel="noopener noreferrer"><span aria-hidden="true">◎</span><div><p class="eyebrow">Instagram</p><h2>@naviopathways</h2><p>Follow updates or send a short message. Opens in a new tab.</p></div></a></div></section>
